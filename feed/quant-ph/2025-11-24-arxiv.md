...
## 3. Magnetically induced Josephson nano-diodes in field-resilient superconducting microwave circuits
...
## 4. Hybrid-spin decoupling for noise-resilient DC quantum sensing
...
## 5. Adiabatic reverse annealing is robust to low-temperature decoherence
...
## 8. Conserved quantities enable the quantum Mpemba effect in weakly open systems
...
## 16. Spectroscopy on a single nonlinear mode recognizes quantum states
...
## 27. Collective early-time spontaneous decay of a strongly driven cold atomic ensemble
...
## 28. Theoretical Analysis of Photonic Resonances in Spectroscopic Measurements of a Kerr Nonlinear Resonator

**作者**: Yuki Tanaka, Aiko Yamaguchi, Tomohiro Yamaji, Yuta Shingu, Keisuke Matsumoto, Tsuyoshi Yamamoto, Yuichiro Matsuzaki

**PDF链接**: [https://arxiv.org/pdf/2511.17197.pdf](https://arxiv.org/pdf/2511.17197.pdf)
...
## 34. Basic cell for a quantum microwave router
...
## 35. Fundamental Limitations of QAOA on Constrained Problems and a Route to Exponential Enhancement
...
## 36. Enhancing Infrared Laser Dissociation of Molecules with the Electromagnetic Vacuum
...
## 44. Time Evolution of Multi-Party Entanglement Signals
...
## 45. Liouvillian topology and non-reciprocal dynamics in open Floquet chains
...
## 46. Excited states from local effective Hamiltonians of matrix product states and their entanglement spectrum transition
...
## 47. Numerical tiling-based simulations of decoherence in multifield models of inflation
...
## 48. Broadband telecom single-photon emissions from InAs/InP quantum dots grown by MOVPE droplet epitaxy
...
## 49. Exponentially enhanced sensing through nonreciprocal light propagation
...
## 50. Quantum Jump Approach for Photosynthetic Energy Transfer with Chemical Reaction and Fluorescence Loss
...
## 51. Pair scattering from time-modulated impurity in the Bose-Hubbard model
...
## 52. Exceptional line and pseudospectrum in black hole spectroscopy
...
## 53. Anyon Quasilocalization in a Quasicrystalline Toric Code
...
## 54. Teaching quantum computing to computer science students: Review of a hands-on quantum circuit simulation practical
...
## 56. Aspects of quantum geometry in photonic time crystals
...
## 59. Measuring Anyonic Exchange Phases Using Two-Dimensional Coherent Spectroscopy
...
## 60. Primitive Quantum Gates for an $SU(3)$ Discrete Subgroup: $Σ(72\times3)$
...
## 61. Thermalization of exact quantum many-body scars in spin-1 XY chain under perturbations
...
## 62. Fractional Chern insulator edges: crystalline effects and optical measurements
...
## 63. Toward Super-polynomial Quantum Speedup of Equivariant Quantum Algorithms with SU($d$) Symmetry
...
## 64. Entanglement behavior and localization properties in monitored fermion systems
...
## 67. Experimental observation of quantum interferences in CO-H$_2$ rotational energy transfer at room temperature
...
## 70. High-temperature partition functions and classical simulatability of long-range quantum systems
...
## 74. Nuclear Spin-Mediated Relaxation Mechanisms of the V$_{B}^-$ Center in hBN
...
## 81. Qumode-Based Variational Quantum Eigensolver for Molecular Excited States
...
## 82. Quantum optics in the turbulent atmosphere: Fundamental issues and applications
...
## 85. From single-particle to many-body chaos in Yukawa--SYK: theory and a cavity-QED proposal
...
## 88. On the non-uniqueness of the energy-momentum and spin currents
...
## 89. On the Schrödingerization method for linear non-unitary dynamics with optimal dependence on matrix queries
...
## 91. Left-Right Husimi Representation of Chaotic Resonance States: Invariance and Factorization
...
## 92. Genuine multi-entropy, dihedral invariants and Lifshitz theory
...
## 93. Axiomatising the dagger category of complex Hilbert spaces
